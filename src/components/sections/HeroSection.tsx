...
import { dividerVertical, fadeUp, scaleIn } from '@/motion/motion';
    ...
    >
        ...
        <div className='relative  flex flex-col gap-10 lg:gap-15 py-10 lg:px-0 lg:py-0 lg:max-w-201.75 z-1 px-4 lg:pr-0'>
          <div className='flex flex-col gap-4'>
            ...
            <motion.p
              ...
              className='font-extrabold text-display-lg lg:text-[55px] xl:text-[80px] lg:leading-7xl xl:leading-8xl'
            >
              BUILDING FAST &{' '}
            ...
            <motion.p
              ...
              className='font-medium text-neutral-400 text-lg lg:text-xl lg:max-w-100 xl:max-w-149.25'
            >
          ...
          <motion.div
            ...
            className='block lg:hidden absolute inset-y-0 inset-x-2 left-3/4 border-l -z-1'
          />
        </div>
        <motion.div
          variants={dividerVertical}
          ...
          className='block lg:hidden absolute inset-y-0 inset-x-2 left-1/2 border-l -z-1'
        />
      </div>
      ...
      <div className='relative flex justify-center  w-full overflow-hidden lg:max-w-165.25 pb-10'>
        <motion.div
          ...
          className='relative w-87 h-115.25 lg:w-full lg:h-220.25'
        >
          <Image
            src={heroImage}
            alt='hero image'
        ...
        <motion.div
          ...
          className='absolute left-1/2 -translate-x-1/2 bg-black border rounded-xl lg:rounded-3xl p-2xl flex flex-col gap-md bottom-10 lg:bottom-21 w-full max-w-87.25'
        >
      ...
      <motion.div
        ...
        className='hidden lg:block absolute inset-y-0 inset-x-2 left-1/2 border-l -z-1'
      />
      <motion.div
        variants={dividerVertical}
        initial='hidden'
        ...
        className='hidden lg:block absolute inset-y-0 inset-x-2 left-1/4 border-l -z-1'
      />
      <div />
